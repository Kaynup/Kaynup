...
![Hadoop](https://img.shields.io/badge/Hadoop-333?logo=apachehadoop&logoColor=white)
![Apache Hive](https://img.shields.io/badge/Apache%20Hive-333?logo=apachehive&logoColor=white)
![Apache Iceberg](https://img.shields.io/badge/Apache%20Iceberg-333)
![Apache Hudi](https://img.shields.io/badge/Apache%20Hudi-333)
...
### <a id="php-auth"></a>🔹 [Basic User Auth with PHP MySQL](https://github.com/Kaynup/Basic-User-Auth-with-PHP-MySQL)
- Implemented a secure user authentication system using raw **PHP** and **MySQL**.
- Handled secure hashing, session management, and SQL query executions.

🔗 [Repository Link](https://github.com/Kaynup/Basic-User-Auth-with-PHP-MySQL)

---

### <a id="linear-regression"></a>🔹 [Optimized Linear Regression | Cython](https://github.com/Kaynup/Optimized-Linear-Regression)
- Built a packaged API system for linear algorithms from scratch with **Cython** datatypes.
- Replaced **Python** overheads with cythonized **C/C++** code, achieving a 40% speedup over **Scikit-learn** (with < 10 features and millions of samples).

🔗 [Repository Link](https://github.com/Kaynup/Optimized-Linear-Regression)

---

### <a id="sentiment"></a>🔹 [Binary Sentiment Classification | JAX and Sklearn](https://github.com/Kaynup/Binary-Text-Classification-with-Sklearn-Jax)
- Full-stack deployment of sentiment classifiers in **Scikit-learn** and **JAX** frameworks.
- Setup model inferences to be handled via **FastAPI** on a **Railway** backend, connected to a **JavaScript**, **HTML5**, and **CSS3** frontend on **Vercel**.

🔗 [Repository Link](https://github.com/Kaynup/Binary-Text-Classification-with-Sklearn-Jax)

---

### <a id="tictactoe"></a>🔹 [Reinforcement Learning Tic-Tac-Toe Q-table Agent](https://github.com/Kaynup/Tic-Tac-Toe-Q-Learning)
- Implemented a tabular Q-Learning agent for Tic-Tac-Toe.
- Fully reproducible training using configurable hyperparameters and random seeds via `config.yaml`.

🔗 [Repository Link](https://github.com/Kaynup/Tic-Tac-Toe-Q-Learning)
